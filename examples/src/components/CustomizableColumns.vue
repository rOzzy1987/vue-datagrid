<template>
  <div>
    <p class="block">
      If you define some columns with <span class="is-family-monospace">.withOptional()</span> or set <span class="is-family-monospace">isColumnListOrderable</span> to true, you'll
      get a new UI control to show/hide or reorder coumns as you please.
    </p>
  ...
  data() {
    return {
      ...
      cols: [
        ...
        new GridColumnDefinition("pr", "Profession", (p: ITestData) => p.profession).withOptional(),
        new GridColumnDefinition("sx", "Sex", (p: ITestData) => p.sex).withOptional().withHidden(),
