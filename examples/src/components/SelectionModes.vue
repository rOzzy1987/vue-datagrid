<template>
  <div>
    ...
    <div class="content">
      <p class="block">
        For the single selection mode just set the <span class="is-family-monospace">selectionMode</span> property to <span class="is-family-monospace">One</span> and hook up a
        propery to <span class="is-family-monospace">selectedItems</span>
      </p>
      <data-grid :model-value="rows" v-model:columns="cols" :items-per-page="20" :selection-mode="GridSelectionMode.One" v-model:selected-items="selectedItems" />
    ...
    <div class="content">
      <p class="block">
        You can use the multiselection mode by setting the <span class="is-family-monospace">selectionMode</span> property to <span class="is-family-monospace">Multi</span>
      </p>
      <p class="block">This way Ctrl + click and Shift + click methods work as usual</p>
      <data-grid :model-value="rows" v-model:columns="cols" :items-per-page="20" :selection-mode="GridSelectionMode.Multi" v-model:selected-items="selectedMultiItems" />
