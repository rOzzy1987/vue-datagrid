<template>
  <div>
    ...
    <p class="block content">The most important thing is defining the columns. Columns have at least 3 parameters set:
        <ul class="list"><li>ID</li><li>Label</li><li>Value expression</li></ul>
        Note that the value expression can return any type. You can later define a <i>format expression</i> for displaying that value using <span class="is-family-monospace">.withFormat()</span>
    </p>
    <p>In this example, the Age and Birthday columns are actually derived from the same data property of the data model: dateOfBirth</p>
