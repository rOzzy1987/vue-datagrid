...
export default class Generator {
  ...
  private getRandomName(isFemale: boolean): IName {
    return {
      ...
      middle: Math.random() > 0.2 ? undefined : this.getRandomChar() + "."
    };
  }
  ...
  private getRandomBirthDate(): Date {
    return new Date(2000 - Math.round(Math.random() * 20), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1);
  }
